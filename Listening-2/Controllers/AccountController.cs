    ...
    public class AccountController : Controller
    {
        ...
        public async Task<JsonResult> ConfirmEmail(string userId, string code)
        {
            if (userId == null || code == null)
                throw new AuthenticationException("No user identifier or verification code from email");
        ...
        public async Task<JsonResult> Login([FromBody]LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.IsLockedOut)
                {
                    ...
                    //return View("Lockout");
                    throw new AuthenticationException("User account locked out. Please contact administrator.");
